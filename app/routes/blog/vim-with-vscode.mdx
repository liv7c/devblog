...
topics:
  - vim
meta:
  title: Using vim with VSCode | Olivia Coumans
  og:title: Using vim with VSCode | Olivia Coumans
  twitter:title: Using vim with VSCode | Olivia Coumans
  description: Blog post sharing some tips about using vim with VSCode
  og:description: Blog post sharing some tips about using vim with VSCode
  twitter:description: Blog post sharing some tips about using vim with VSCode
  keywords:
    - vim
---
