...
topics:
  - typescript
meta:
  title: An overview of the unknown type in Typescript | Olivia Coumans
  og:title: An overview of the unknown type in Typescript | Olivia Coumans
  twitter:title: An overview of the unknown type in Typescript | Olivia Coumans
  ...
  og:description: This blog post explores what the unknown type is in Typescript and how to use it. It also highlights some of the differences between any and unknown.
  twitter:description: This blog post explores what the unknown type is in Typescript and how to use it. It also highlights some of the differences between any and unknown.
  keywords:
    - typescript
date: 2022-01-21
---
