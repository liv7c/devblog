...
meta:
  ...
  og:title: Getting started with tmux | Olivia Coumans
  twitter:title: Getting started with tmux | Olivia Coumans
  ...
  og:description: tmux is a great tool to make your dev life easier. It enables you to manage multiple sessions, terminal windows, and panes from one terminal screen. This blog post will look at how to configure it and at some of the cool things we can do with tmux.
  twitter:description: tmux is a great tool to make your dev life easier. It enables you to manage multiple sessions, terminal windows, and panes from one terminal screen. This blog post will look at how to configure it and at some of the cool things we can do with tmux.
  keywords:
    - tmux
---
